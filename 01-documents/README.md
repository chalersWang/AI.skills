...
| **graphify** | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 119k | 代码库 + 文档 + SQL + PDF → 可查询知识图谱 |
| **book-to-skill** | [virgiliojr94/book-to-skill](https://github.com/virgiliojr94/book-to-skill) | 31.1k | 技术书 PDF 一键转 Claude Code skill |
...
| **dashi-ppt-skill** | [chuspeeism/dashi-ppt-skill](https://github.com/chuspeeism/dashi-ppt-skill) | 8.4k | 多主题、浏览器可编辑演示，导出 HTML/PDF/PPTX |
...
| **svg-diagram** | [bybit-exchange/svg-diagram](https://github.com/bybit-exchange/svg-diagram) | 566 | 架构/流程/时序/数据流 SVG |
